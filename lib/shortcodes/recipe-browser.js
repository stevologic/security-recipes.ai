...
function seedCards(cards) {
  return cards.slice(0, SSR_PAGE_SIZE);
}
...
module.exports = function recipeBrowser() {
  ...
  return (
    `<section class="recipe-browser recipe-library" data-recipe-browser data-recipe-feed-policy="interaction" data-recipe-api="/api/curated-recipes.json" ` +
