// Shared derivations for prompt-library recipes. The recipe browser
...
const FEED_CATEGORIES = [
  ["prompt-library/cve/", "cve", "CVE"],
  ["prompt-library/general/classic-vulnerable-defaults/", "classic-defaults", "Classic Vulnerable Defaults"],
  ["prompt-library/general/compliance-standards/", "compliance-standards", "Compliance Standards"],
  ["prompt-library/general/crypto-defi/", "crypto-defi", "Crypto/DeFi"],
  ["prompt-library/claude/", "claude", "Claude"],
  ["prompt-library/github_copilot/", "github-copilot", "GitHub Copilot"],
  ["prompt-library/cursor/", "cursor", "Cursor"],
  ["prompt-library/codex/", "codex", "Codex"],
  ["prompt-library/devin/", "devin", "Devin"],
];

const BROWSER_CATEGORIES = [
  ["prompt-library/cve/", "cve", "CVE"],
  ["prompt-library/general/classic-vulnerable-defaults/", "classic-defaults", "Defaults"],
  ["prompt-library/general/compliance-standards/", "compliance-standards", "Compliance"],
  ["prompt-library/general/crypto-defi/", "crypto-defi", "Crypto/DeFi"],
];
...
// Full derived model for one content-index page from prompt-library.
function recipeModel(page) {
  ...
  const facets = [...new Set(facetsFor(facetText, feedCategory.slug === "cve"))];
...
module.exports = { recipeModel, categorize, FEED_CATEGORIES, BROWSER_CATEGORIES };
