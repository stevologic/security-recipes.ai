...
// Strip tags from rendered HTML to approximate Hugo's .Plain on rendered
// content (used for content_text in the agent feed).
...
module.exports = { escapeHtml, truncate, plainifyMarkdown, stripHtml, isoDate, localDate };
