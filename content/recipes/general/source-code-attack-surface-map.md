...
- [Source code audit - auth and tenant boundaries]({{< relref "/recipes/general/source-code-authz-tenant-boundary-audit" >}})
- [Source code audit - injection and unsafe sinks]({{< relref "/recipes/general/source-code-injection-sink-audit" >}})
- [Source code audit - secrets and data exposure]({{< relref "/recipes/general/source-code-secrets-data-exposure-audit" >}})
- [Source code audit - dependency and build integrity]({{< relref "/recipes/general/source-code-supply-chain-build-integrity-audit" >}})
