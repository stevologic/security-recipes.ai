...
jurisdiction: ["european-union", "eea", "extraterritorial"]
jurisdictions: ["european-union", "eea", "extraterritorial"]
industry: ["cross-sector"]
industries: ["cross-sector"]
facets: ["audit", "compliance", "privacy", "data-protection"]
official_sources: ["https://eur-lex.europa.eu/eli/reg/2016/679/oj?locale=EN"]
routing_positive: ["assess GDPR accountability evidence", "review personal-data processing governance", "prepare records of processing and DPIA evidence"]
routing_hard_negative: ["assess NIS2 cybersecurity risk measures", "review ISO 27701 certification evidence only"]
...
# EU GDPR Accountability Evidence Check

Use this recipe to produce a source-aware evidence-readiness assessment for **EU GDPR**. It creates an auditable gap record; it does not certify compliance, provide legal advice, or replace an assessor, regulator, or certification body.
...
Controllers and processors handling personal data within GDPR territorial scope, including applicable extraterritorial processing.
...
- processing inventory and lawful basis: begin with records of processing activities.
- data subject rights: begin with DPIAs and legitimate-interest assessments.
- privacy by design and security: begin with rights request and retention records.
- processors, transfers, incidents, and accountability: begin with transfer, processor, and breach documentation.

## The prompt

```markdown
You are a compliance evidence-readiness analyst. Evaluate the supplied scope against EU GDPR (Regulation (EU) 2016/679). The catalog status is final and the source review date is 2026-08-21.
...
1. processing inventory and lawful basis
2. data subject rights
3. privacy by design and security
4. processors, transfers, incidents, and accountability

Start with these likely artifacts, then validate provenance and coverage:

1. records of processing activities
2. DPIAs and legitimate-interest assessments
3. rights request and retention records
4. transfer, processor, and breach documentation
...
Return one Markdown file named EU_GDPR_ACCOUNTABILITY_EVIDENCE_CHECK.md with:
...
- assess GDPR accountability evidence
- review personal-data processing governance
- prepare records of processing and DPIA evidence

Hard negatives—route elsewhere or clarify:

- assess NIS2 cybersecurity risk measures
- review ISO 27701 certification evidence only

## Related recipes

- [NIST Privacy Framework](../nist-privacy-framework-evidence-check/)
- [ISO/IEC 27701:2025](../iso27701-2025-privacy-management-evidence-check/)
- [CIS Controls v8.1](../cis-controls-safeguard-implementation-check/)

## References

1. [European Union official source 1](https://eur-lex.europa.eu/eli/reg/2016/679/oj?locale=EN)
