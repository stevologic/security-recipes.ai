...
industry: ["cloud", "saas", "cross-sector"]
industries: ["cloud", "saas", "cross-sector"]
facets: ["audit", "compliance", "cloud", "assurance"]
official_sources: ["https://cloudsecurityalliance.org/artifacts/cloud-controls-matrix-v4-1"]
routing_positive: ["assess cloud controls with CSA CCM 4.1", "prepare CAIQ-aligned evidence", "review cloud shared responsibilities"]
routing_hard_negative: ["perform a FedRAMP authorization assessment", "assess SOC 2 criteria without a cloud mapping"]
...
# CSA Cloud Controls Matrix v4.1 Evidence Check

Use this recipe to produce a source-aware evidence-readiness assessment for **CSA CCM v4.1**. It creates an auditable gap record; it does not certify compliance, provide legal advice, or replace an assessor, regulator, or certification body.
...
Cloud service providers and cloud customers assessing cloud control responsibilities using CSA CCM v4.1.
...
- cloud governance and shared responsibility: begin with shared-responsibility matrix.
- identity, infrastructure, and application security: begin with cloud configuration exports.
- data security and privacy: begin with data lifecycle and key-management evidence.
- operations, resilience, and supply chain: begin with resilience tests and supplier reviews.

## The prompt

```markdown
You are a compliance evidence-readiness analyst. Evaluate the supplied scope against CSA CCM v4.1 (4.1). The catalog status is final and the source review date is 2026-08-21.
...
1. cloud governance and shared responsibility
2. identity, infrastructure, and application security
3. data security and privacy
4. operations, resilience, and supply chain

Start with these likely artifacts, then validate provenance and coverage:

1. shared-responsibility matrix
2. cloud configuration exports
3. data lifecycle and key-management evidence
4. resilience tests and supplier reviews
...
Return one Markdown file named CSA_CCM_4_1_CLOUD_CONTROL_EVIDENCE_CHECK.md with:
...
- assess cloud controls with CSA CCM 4.1
- prepare CAIQ-aligned evidence
- review cloud shared responsibilities

Hard negatives—route elsewhere or clarify:

- perform a FedRAMP authorization assessment
- assess SOC 2 criteria without a cloud mapping
...
1. [Cloud Security Alliance official source 1](https://cloudsecurityalliance.org/artifacts/cloud-controls-matrix-v4-1)
