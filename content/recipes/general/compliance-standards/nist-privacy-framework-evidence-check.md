...
facets: ["audit", "compliance", "privacy", "risk"]
official_sources: ["https://www.nist.gov/privacy-framework"]
routing_positive: ["build a NIST Privacy Framework profile", "assess privacy risk outcomes", "collect Privacy Framework 1.0 evidence"]
routing_hard_negative: ["apply the 1.1 draft as final", "perform a GDPR legal compliance determination"]
...
# NIST Privacy Framework 1.0 Profile Evidence Check

Use this recipe to produce a source-aware evidence-readiness assessment for **NIST Privacy Framework**. It creates an auditable gap record; it does not certify compliance, provide legal advice, or replace an assessor, regulator, or certification body.
...
Organizations using Privacy Framework 1.0 to manage privacy risk; version 1.1 remains an Initial Public Draft and must not be treated as final.

A draft update exists. Treat only the identified final version as normative unless the user explicitly requests a draft gap preview.
...
- privacy governance and risk context: begin with current and target privacy profiles.
- data processing inventory: begin with data processing maps.
- individual participation and communication: begin with privacy risk assessments.
- protective controls and improvement profile: begin with rights, communication, protection, and improvement records.
...
4. A draft update exists. Treat only the identified final version as normative unless the user explicitly requests a draft gap preview.
...
1. privacy governance and risk context
2. data processing inventory
3. individual participation and communication
4. protective controls and improvement profile

Start with these likely artifacts, then validate provenance and coverage:

1. current and target privacy profiles
2. data processing maps
3. privacy risk assessments
4. rights, communication, protection, and improvement records
...
Return one Markdown file named NIST_PRIVACY_FRAMEWORK_EVIDENCE_CHECK.md with:
...
- build a NIST Privacy Framework profile
- assess privacy risk outcomes
- collect Privacy Framework 1.0 evidence

Hard negatives—route elsewhere or clarify:

- apply the 1.1 draft as final
- perform a GDPR legal compliance determination

## Related recipes

- [EU GDPR](../eu-gdpr-accountability-evidence-check/)
...
1. [NIST official source 1](https://www.nist.gov/privacy-framework)
