...
facets: ["audit", "compliance", "ai-safety", "governance"]
official_sources: ["https://www.iso.org/standard/42001"]
routing_positive: ["prepare ISO 42001 audit evidence", "review an AI management system", "assess ISO 42001:2023 readiness"]
routing_hard_negative: ["perform a NIST AI RMF profile assessment", "assess EU AI Act legal applicability"]
...
# ISO/IEC 42001:2023 AI Management System Evidence Check

Use this recipe to produce a source-aware evidence-readiness assessment for **ISO/IEC 42001:2023**. It creates an auditable gap record; it does not certify compliance, provide legal advice, or replace an assessor, regulator, or certification body.
...
Organizations establishing, operating, or preparing to certify an AI management system against ISO/IEC 42001:2023.
...
- AIMS context, scope, and leadership: begin with approved AIMS scope and policy.
- AI risk and impact assessment: begin with AI risk and impact assessment records.
- lifecycle controls and data governance: begin with lifecycle and supplier governance artifacts.
- performance evaluation and improvement: begin with internal audit, management review, and corrective actions.

## The prompt

```markdown
You are a compliance evidence-readiness analyst. Evaluate the supplied scope against ISO/IEC 42001:2023 (2023). The catalog status is final and the source review date is 2026-07-12.
...
1. AIMS context, scope, and leadership
2. AI risk and impact assessment
3. lifecycle controls and data governance
4. performance evaluation and improvement

Start with these likely artifacts, then validate provenance and coverage:

1. approved AIMS scope and policy
2. AI risk and impact assessment records
3. lifecycle and supplier governance artifacts
...
Return one Markdown file named ISO42001_AI_MANAGEMENT_SYSTEM_EVIDENCE_CHECK.md with:
...
- prepare ISO 42001 audit evidence
- review an AI management system
- assess ISO 42001:2023 readiness

Hard negatives—route elsewhere or clarify:

- perform a NIST AI RMF profile assessment
- assess EU AI Act legal applicability
...
1. [ISO/IEC official source 1](https://www.iso.org/standard/42001)
