...
facets: ["audit", "compliance", "data-protection", "incident-response"]
official_sources: ["https://www.dfs.ny.gov/industry_guidance/cybersecurity"]
routing_positive: ["assess NYDFS Part 500 evidence", "review class A cybersecurity obligations", "prepare DFS cybersecurity certification support"]
routing_hard_negative: ["assess GLBA Safeguards Rule only", "prepare SEC public-company cyber disclosures"]
...
# NYDFS 23 NYCRR Part 500 Evidence Check

Use this recipe to produce a source-aware evidence-readiness assessment for **NYDFS Part 500**. It creates an auditable gap record; it does not certify compliance, provide legal advice, or replace an assessor, regulator, or certification body.
...
NYDFS covered entities, with obligations determined by covered-entity and class-A status and the amendment's phased effective dates.
...
- covered-entity scope and governance: begin with status and exemption determination.
- risk assessment and cybersecurity program: begin with CISO and board reports.
- access, monitoring, and resilience: begin with asset, access, monitoring, and backup records.
- third parties, incidents, and certification: begin with incident notices and annual certification support.
...
1. covered-entity scope and governance
2. risk assessment and cybersecurity program
3. access, monitoring, and resilience
4. third parties, incidents, and certification

Start with these likely artifacts, then validate provenance and coverage:

1. status and exemption determination
2. CISO and board reports
3. asset, access, monitoring, and backup records
4. incident notices and annual certification support
...
Return one Markdown file named NYDFS_PART_500_EVIDENCE_CHECK.md with:
...
- assess NYDFS Part 500 evidence
- review class A cybersecurity obligations
- prepare DFS cybersecurity certification support

Hard negatives—route elsewhere or clarify:

- assess GLBA Safeguards Rule only
- prepare SEC public-company cyber disclosures
...
1. [New York State Department of Financial Services official source 1](https://www.dfs.ny.gov/industry_guidance/cybersecurity)
