...
- [Kubernetes configuration good practices](https://kubernetes.io/blog/2025/11/25/configuration-good-practices/) — Kubernetes
- [GitHub Actions workflow syntax](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax) — GitHub
- [Kubernetes liveness, readiness, and startup probes](https://kubernetes.io/docs/concepts/workloads/pods/probes/) — Kubernetes
