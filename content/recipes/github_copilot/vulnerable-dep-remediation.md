...
- [Codex vulnerable dependency remediation]({{< relref "/recipes/codex/vulnerable-dep-remediation" >}})
- [Cursor vulnerable dependency remediation]({{< relref "/recipes/cursor/vulnerable-dep-remediation" >}})
