...
- Runtime evaluator: `scripts/evaluate_agentic_soc_detection_event.py`
- Evidence pack:
  `data/evidence/agentic-soc-detection-pack.json`
- MCP tools:
  `recipes_agentic_soc_detection_pack`, paired with `recipes_playbook_plan` using playbook id `agentic-soc-detection-pack`.
