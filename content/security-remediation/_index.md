...
{{< cards >}}
  ...
  {{< card link="/security-remediation/agentic-standards-crosswalk/" title="Agentic Standards Crosswalk" subtitle="Generated OWASP, NIST, MCP, OpenAI, and Anthropic standards-to-evidence map for buyer diligence and MCP-native control review." >}}
