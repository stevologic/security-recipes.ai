...
model: "gpt-5-codex"
recipe_id: "code-hygiene.javascript-typescript.javascript-promise-abort-and-listener-lifecycle"
recipe_kind: "code-hygiene"
scope: "javascript-typescript"
ecosystem: "javascript-typescript/npm"
facets: ["code-hygiene", "audit", "remediation"]
tags: ["code-hygiene", "javascript-typescript", "javascript", "promises", "abortcontroller", "listeners"]
weight: 202
date: 2026-07-12
...
A tool-agnostic recipe to close floating promises, lost failures, uncancelled work, and leaked event listeners. It supports a read-only audit and, when explicitly authorized, a narrow remediation.

## When to use it

Use this recipe when the operator's specific objective is to close floating promises, lost failures, uncancelled work, and leaked event listeners. Prefer a narrower CVE, scanner-finding, security-audit, or compliance-evidence recipe when that is the operator's actual job.
...
~~~markdown
You are running the Security Recipes code-hygiene workflow `code-hygiene.javascript-typescript.javascript-promise-abort-and-listener-lifecycle`.
...
Your bounded objective is to close floating promises, lost failures, uncancelled work, and leaked event listeners.
...
- Trace promise creation, awaiting, rejection ownership, AbortSignal propagation, and listener registration/removal.
- Find fire-and-forget work without an explicit owner or terminal error handler.
...
- Attach work to an owning lifecycle, propagate cancellation, and pair every listener with deterministic cleanup.
...
- Test success, rejection, cancellation, timeout, teardown, and repeated mount or invocation paths.
...
- Stop if changing concurrency or event ordering could affect external protocols without characterization tests.
...
- [TypeScript strictness and escape-hatch debt]({{< relref "/prompt-library/general/code-hygiene/javascript-typescript/typescript-strictness-and-escape-hatches" >}})
- [JavaScript module cycles, side effects, and unused exports]({{< relref "/prompt-library/general/code-hygiene/javascript-typescript/javascript-module-cycles-side-effects-and-unused-exports" >}})
