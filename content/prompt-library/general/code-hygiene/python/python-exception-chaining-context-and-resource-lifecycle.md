...
model: "gpt-5-codex"
recipe_id: "code-hygiene.python.python-exception-chaining-context-and-resource-lifecycle"
recipe_kind: "code-hygiene"
scope: "python"
ecosystem: "python/pypi"
facets: ["code-hygiene", "audit", "remediation"]
tags: ["code-hygiene", "python", "exceptions", "context-managers", "resources"]
weight: 303
date: 2026-07-12
...
A tool-agnostic recipe to preserve exception context and deterministically release files, locks, sessions, and generators. It supports a read-only audit and, when explicitly authorized, a narrow remediation.

## When to use it

Use this recipe when the operator's specific objective is to preserve exception context and deterministically release files, locks, sessions, and generators. Prefer a narrower CVE, scanner-finding, security-audit, or compliance-evidence recipe when that is the operator's actual job.
...
~~~markdown
You are running the Security Recipes code-hygiene workflow `code-hygiene.python.python-exception-chaining-context-and-resource-lifecycle`.
...
Your bounded objective is to preserve exception context and deterministically release files, locks, sessions, and generators.
...
- Find broad catches, swallowed exceptions, raise-without-chaining, manual close paths, and generator cleanup gaps.
- Trace ownership across normal return, exception, cancellation, and partial initialization.
...
- Use narrow exception handling and context management at the resource owner.
...
- Test success and each failure edge while asserting cleanup and preserved exception cause.
...
- Stop if changing exception types would break a documented caller contract.
...
- [Python typing Any and ignore debt]({{< relref "/prompt-library/general/code-hygiene/python/python-typing-any-and-ignore-debt" >}})
- [Python mutable-default, dataclass, and sentinel hygiene]({{< relref "/prompt-library/general/code-hygiene/python/python-mutable-default-dataclass-and-sentinel-hygiene" >}})
