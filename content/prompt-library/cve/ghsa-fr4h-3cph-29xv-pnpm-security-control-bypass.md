---
title: "GHSA-FR4H-3CPH-29XV - pnpm security control bypass"
linkTitle: "GHSA-FR4H-3CPH-29XV security control bypass"
...
aliases: ["GHSA-FR4H-3CPH-29XV", "pnpm security control bypass"]
kev: false
severity: "high"
...
2. Confirm whether the vulnerable path is reachable: `alias` and attacker-controlled parameter `input` are the first review anchors.
