...
{{< cards >}}
  ...
  {{< card link="/security-remediation/secure-context-customer-proof-pack/" title="Customer Proof Pack ->" subtitle="Generated runtime event, metric, receipt, renewal-gate, and acquisition-proof contract for design partner pilots." >}}
  ...
  {{< card link="/security-remediation/agentic-aivss-risk-scoring/" title="Agentic AIVSS Risk Scoring ->" subtitle="Generated severity, SLA, remediation queue, owner, hosted MCP wedge, and runtime decision layer for agentic risk." >}}
