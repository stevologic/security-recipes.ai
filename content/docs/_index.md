...
{{< cards >}}
  {{< card link="/docs/marketplace-gallery/" title="Marketplace Gallery ->" subtitle="Public inventory of browser input channels, report contracts, output routes, and workflow packs contributed through Hugo data files." >}}
